...
const KNOWLEDGE_BASE: Record<string, string> = {
  ...
  "certifications": "AI: AI & Productivity (Google), Generative AI Mastermind (Outskill), AI Agent Fundamentals (Databricks), AWS AI Practitioner (Udacity). Development: Quantitative Research J.P. Morgan (Forage), Software Engineering J.P. Morgan (Forage). Other: Claude Code In Action (Anthropic), SQL Essential Training (LinkedIn).",
  ...
  "cover_letter": "Pratik Balaji's Cover Letter: As a Data Science with Computational Analytics student at Temple University, he has developed a deep foundation in predictive modeling, statistical analysis, and artificial intelligence. At Auxilior Capital Partners Inc., he runs AI operations under VP leadership, integrating automated tools and optimizing secure financial systems while deploying custom AI agents. At YAN IT Solutions, he built Python pipelines to process IoT sensor data from MongoDB, improving predictive accuracy by 40% and reducing device downtime by 35% across 230+ endpoints. He developed the Startup Success Predictor with 70% test accuracy, and for the AROMA project achieved a 95% automated response rate. He built AURA ATLAS with Mapbox 3D routing and AR using GPT 4o. His technical stack spans Python, TensorFlow, scikit-learn, AWS, and modern AI agent frameworks.",
  "AURA": "AURA ATLAS - Agentic Geospatial Wellness Network (Spring 2026): Architected Mapbox GL JS 3D routing with bounding box constraints, cutting false-positives by 40%. Developed Next.js navigation HUD with emotional weather system, accelerating decisions by 60%. Engineered 2-step proximity search algorithm and AR using GPT 4o, achieving 95% success for local landmarks. Optimized React state-management for map rendering, ensuring zero-latency transitions across 11 cities.",
  "auxilior": "Auxilior Capital Partners Inc. (IT Intern, May-Sep 2026, Plymouth Meeting PA): Running AI operations under VP leadership to integrate automated tools and optimize secure financial systems. Automating data workflows and deploying custom AI agents to streamline internal reporting and enhance efficiency.",
};
