...
const KNOWLEDGE_BASE: Record<string, string> = {
  "IoT": "YAN IT Solutions: Implemented Python pipelines to process IoT sensor data from MongoDB. Monitored device health and predicted refill needs with ML (Linear Regression). Achieved 40% improvement in predictive accuracy and 35% reduction in downtime for 230+ devices. Deployed to Azure App Services. 85% uptime, 55% increase in data output.",
  "AROMA": "AROMA - Agentic Restaurant Order Management Automation (Fall 2025): Automated restaurant order processing via n8n agentic workflows, cutting manual time by 40%. Integrated Vapi conversational AI voice agent. Engineered real-time WhatsApp order notification system, decreasing follow-up calls by 60%. 95% automated response rate.",
  "SSP": "SSP - Startup Success Predictor (Spring 2026): Built ML pipeline with 4 models (Random Forest, XGBoost, Gradient Boosting, Logistic Regression). Flask REST API with probability-based predictions across 3 success classes. 69.6% CV score and 70% test accuracy.",
  "skills": "Programming: Python, C, C++, Java, JavaScript, SQL, R, Bash. Stack: TensorFlow, PyTorch, MongoDB, scikit-learn, Pandas, NumPy, Flask, FastAPI, Docker, Git. Adobe: AEP, Real-Time CDP, CJA. Other: Cloud Computing, ML, Deep Learning, AWS, AI Agents, n8n, IoT.",
  "education": "Temple University, Philadelphia, PA. BS Data Science with Computational Analytics (Expected 2027). Coursework: Calc I-III, Data Structures, Algorithms, Principles of Data Science, Linear Algebra, Database Systems, Probability Theory.",
  "experience": "YAN IT Solutions (Data Analyst Intern, June-Sept 2025): IoT data pipelines, ML predictions, Azure deployment. Natraj Beats LLC (Web Developer & Consultant, Feb 2025-Jan 2026): Built NatrajBeats platform via Lovable AI, automated booking pipeline, 30% more leads.",
  "certifications": "AI: AI & Productivity (Google), Generative AI Mastermind (Outskill), AI Agent Fundamentals (Databricks). Development: Python (Santander), Intro to Data Science (Santander), SQL Essential Training (LinkedIn).",
  "contact": "Pratik Balaji, Philadelphia PA 19122. Phone: (346) 446-8717. Email: balajipratik8@gmail.com. LinkedIn: linkedin.com/in/pratikbalaji. GitHub: github.com/PratikBalaji. Portfolio: pratikbalaji.lovable.app",
};
