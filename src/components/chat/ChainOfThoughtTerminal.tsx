...
const STEP_CONFIG: Record<AgentStep['type'], { prefix: string; color: string; icon: string }> = {
  thought: { prefix: 'THOUGHT', color: 'text-yellow-400', icon: '🧠' },
  action: { prefix: 'ACTION', color: 'text-cyan-400', icon: '⚡' },
  observation: { prefix: 'OBSERVATION', color: 'text-green-400', icon: '👁' },
  error: { prefix: 'ERROR', color: 'text-red-400', icon: '✖' },
};
