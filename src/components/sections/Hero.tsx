      ...
      <motion.div style={{ opacity: contentOpacity }} className="container-tight relative z-10">
        ...
        >
          ...
          <motion.h1
            ...
            className="font-display text-5xl md:text-7xl lg:text-8xl font-bold leading-tight tracking-tight mb-6 text-foreground"
          >
            Pratik Balaji
          </motion.h1>
          ...
          <motion.p
            ...
            style={{ fontFamily: "'Cormorant Garamond', serif", fontStyle: 'italic', fontSize: '1.25rem', lineHeight: '1.8', textShadow: '0 0 10px hsl(270 100% 64% / 0.5), 0 0 30px hsl(270 100% 64% / 0.25), 0 0 60px hsl(270 100% 64% / 0.1)' }}
          >
          ...
          {/* Social Links */}
          <motion.div variants={staggerItem} className="flex items-center justify-center gap-4 mb-10">
            <a
            ...
            <a
              ...
              aria-label="LinkedIn"
            >
              <LinkedInLogo className="w-5 h-5 text-foreground" />
            </a>
          </motion.div>
          ...
          <motion.div variants={staggerItem} className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <MagneticButton
              ...
              className="group px-8 py-4 text-foreground font-medium rounded-full hover:scale-105 transition-all duration-300 [text-shadow:0_0_10px_hsl(var(--accent)/0.5),0_0_25px_hsl(var(--accent)/0.2)]"
            >
              <span className="relative z-10">View My Work</span>
            </MagneticButton>
            <MagneticButton
              onClick={() => document.querySelector('#contact')?.scrollIntoView({ behavior: 'smooth' })}
              className="px-8 py-4 text-foreground font-medium rounded-full hover:scale-105 transition-all duration-300 [text-shadow:0_0_10px_hsl(var(--accent)/0.5),0_0_25px_hsl(var(--accent)/0.2)]"
            >
              Hire Me
            </MagneticButton>
          </motion.div>
